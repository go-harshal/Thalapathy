...
post {
        success {
            mail to:"harshal.gondane@zohomail.in", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"harshal.gondane@zohomail.in", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
